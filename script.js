...
function initApp() {
    ...
    document.querySelector("#open-create-post-dialog").addEventListener("click", showCreatePost);

    document.querySelector("#close-create-post-dialog").addEventListener("click", hideCreatePost);
    ...
    document.querySelector("#btn-close-dialog").addEventListener("click", hidePostClicked);

    //-------------SEARCH SORT FILTER-------------//

    document.querySelector("#input-search").addEventListener("input", searchPosts);
...
function imageClicked(postObject) {
    ...
    document.querySelector("#btn-update").addEventListener("click", () => updateClicked(postObject));
...
function updateClicked(postObject) {
    if (!postObject || !postObject.image || !postObject.description || !postObject.name || !postObject.year || !postObject.song) {
